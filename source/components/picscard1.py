...
def render(app: Dash) -> html.Div:
    ...
    @app.callback(Output(ids.SHOW_IMAGE1, 'children'),
                  [Input(ids.UPLOAD_IMAGE1, 'contents')],
                  State(ids.UPLOAD_IMAGE1, 'filename'),
                  )
    ...
    @app.callback(
        Output(ids.PICS_CARD1, "children"),
        [Input(ids.BUTTON_CLEARPICS1, "n_clicks")])
    def clear_pics(n_clicks):
        ...
        children=[
            ...
            html.Div(id= ids.SHOW_IMAGE1, children= []),
            html.Div(id= ids.PICS_ALERT1, children= []),
            html.Div(dbc.Button("Clear Pictures",
                           id= ids.BUTTON_CLEARPICS1,
